...
public class PlayTetris2 {
	...
	public PlayTetris2(Tetris tetrisIn) {
		tetris = tetrisIn;
	...
	public void makeChoice() {
		...
		if (hold >= 0 && tetris.getHoldable() && hold != next) {
			holdResult = playGame(tempGrid, hold, next);
		}
	...
	public int[] playGame(byte[][] grid, byte currentIn, byte next) {
		...
		return new int[] {minHoles, minRotation, minX};

...
def save_data():
	...
	pickle.dump(m, open("data/extra" + str(save_events) + ".p", "wb"))
...
try:
	print('\nLoading data.')
	d = pickle.load(open("not_processed.p", "rb"))
	d2 = pickle.load(open("data.p", "rb"))
	print('Data loaded from file.')
	q.queue = queue.deque([int(i) for i in d['not_processed']])
	print('Queue loaded.')
	processed = d2['processed']

...
players.append(['Cellox'])
players.append(['Cewqt', 'Asani'])
players.append(['Cooleja'])
players.append(['Escá'])
players.append(['Eshlikk'])
players.append(['Ertanias'])
players.append(['Havocwreaker'])
players.append(['Jobo'])
players.append(['Khatia'])
players.append(['Khrubby', 'Phrubby'])
players.append(['Kimáhri', 'Fènrir', 'Sephìroth', 'Aéris', 'Báhamut', 'Ifrìt'])
players.append(['Klistermärke'])
players.append(['Kraftmärta'])
players.append(['Ligger', 'Rättvisa'])
#players.append(['Paradarswe', 'Kikeni', 'Sneakysami', 'Owlboy', 'Chickenboy'])
players.append(['Samcro'])
players.append(['Saweetroll'])
players.append(['Snakso', 'Snakaso', 'Asymptotem', 'Tsumester', 'Gimlina', 'Snawks'])
players.append(['Teríth'])
players.append(['Topdeck'])
players.append(['Vaju', 'Zaelo'])
players.append(['Venerated', 'Yemy', 'Markemang'])
players.append(['Vudax', 'Vudaz', 'Vudak'])
players.append(['Wepolo'])
players.append(['Xaap'])
players.append(['Yaxzdruid'])
players.append(['Zertias'])
players.append(['Zinqier', 'Nyfsa', 'Mowdra', 'Azméa', 'Vima'])
players.append(['Zlóóz', 'Flóóz'])
players.append(['Zoranda'])
...
classes = ['Warior', 'Paladin', 'Hunter', 'Rogue', 'Priest', 'DeadKnight', 'Shaman', 'Mage', 'Warlock', 'Monk', 'Druid']
		...
		if (player != 'totalFights'):
			if (len(finalRaidDates)-i-1 < checkRaids):
				if (player in attendanceDict.keys()):
					attendanceDict[player] += raidDateDict[raid][player]/raidDateDict[raid]['totalFights']
				else:
					attendanceDict[player] = raidDateDict[raid][player]/raidDateDict[raid]['totalFights']
